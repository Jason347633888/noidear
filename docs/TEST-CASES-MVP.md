...
- [x] **USER-EDIT-006**: 编辑用户-重置密码 (P0) ✓ 功能已实现 2026-02-04 (API: POST /users/:id/reset-password)
...
- [x] **DOC-LIST-002**: 文件列表-分级显示 (P0) ✓ 功能已实现 2026-02-04 (根据路由/level1/level2/level3 显示)
...
### 6.5 任务锁定
- [x] **TASK-LOCK-001**: 第一人提交锁定 (P0) ✓ 功能已实现 2026-02-04 (后端检查已有记录则拒绝)
- [x] **TASK-LOCK-002**: 锁定后不可编辑 (P0) ✓ 功能已实现 2026-02-04 (前端检测锁定状态隐藏表单)
...
> - USER-EDIT-006: 重置密码已实现
> - DOC-LIST-002: 文件分级显示已实现
> - TASK-LOCK-001/002: 任务锁定功能已实现
> - 剩余待实现: 文件搜索/筛选/审批历史/逾期提醒等
> **MVP范围**: Phase 1-6
