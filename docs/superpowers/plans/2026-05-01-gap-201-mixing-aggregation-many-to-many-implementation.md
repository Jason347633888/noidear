...
- **grill-with-docs 校准结论：** 已对照 `docs/MASTER_DATA_AND_TRACEABILITY_MODEL.md` 和 `docs/module-usage/06-mixing-production-packaging.md`，确认本计划不新增主数据、不引入平行批次链路、不破坏 `ProductionBatch / MaterialBatch / BatchMaterialUsage / InventoryMovement` 主链。
