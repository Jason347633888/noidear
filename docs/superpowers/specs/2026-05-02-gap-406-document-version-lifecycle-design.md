...
- `docs/module-usage/03-document-control-and-record-forms.md`：治理记录链为 `Document -> DocumentVersion -> DocumentIssuance -> DocumentReadRequirement -> DocumentReadConfirmation`，受控文件事实源是 `Document`。
