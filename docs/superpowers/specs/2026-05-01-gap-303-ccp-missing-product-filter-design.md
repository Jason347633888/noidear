...
- `docs/module-usage/07-quality-qc-release.md`：GAP-303 已验证，根因是 `findMissingCCPs` 未按产品/配方过滤 CCPPoint。
- `docs/module-usage/97-gap-triage.md`：GAP-303 为 P1、已验证、`needs_spec`，必须走 `brainstorming -> grill-with-docs -> writing-plans`。
