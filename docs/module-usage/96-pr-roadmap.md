...
| 24 | nonconformance/GAP-316 | GAP-316 | GAP-304（已完成） | `docs/superpowers/specs/2026-05-02-gap-316-capa-trigger-source-validation-design.md` | `docs/superpowers/plans/2026-05-02-gap-316-capa-trigger-source-validation-implementation.md` | `executing-plans` | 是 | CAPA 创建时按 trigger_type 校验 NonConformance/CustomerComplaint/AuditFinding 来源，并提供 trigger_type + trigger_id 反查接口 |
