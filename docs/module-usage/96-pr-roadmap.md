...
| 28 | training/GAP-410 | GAP-410 | GAP-316 | `docs/superpowers/specs/2026-05-02-gap-410-audit-finding-capa-linkage-design.md` | `docs/superpowers/plans/2026-05-02-gap-410-audit-finding-capa-linkage-implementation.md` | `executing-plans` | 是 | 内审不符合项验证通过后幂等创建 `trigger_type=internal_audit` CAPA；不新增 AuditFinding FK，不迁移历史 verified 发现项 |
