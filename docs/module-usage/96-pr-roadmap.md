...
| 21 | nonconformance/GAP-313 | GAP-313 | 无 | `docs/superpowers/specs/2026-05-02-gap-313-nc-source-validation-and-index-design.md` | `docs/superpowers/plans/2026-05-02-gap-313-nc-source-validation-and-index-implementation.md` | `executing-plans` | 是 | NonConformance 创建时校验 `source_type + source_id` 来源存在，并保留 `@@index([company_id, source_type, source_id])` |
