...
| 28 | nonconformance/GAP-315 | GAP-315 | GAP-304（已完成） | `docs/superpowers/specs/2026-05-02-gap-315-nc-dispose-to-rework-record-design.md` | `docs/superpowers/plans/2026-05-02-gap-315-nc-dispose-to-rework-record-implementation.md` | `executing-plans` | 否 | NonConformance 生产批次来源处置为 rework 时事务内自动创建 pending ReworkRecord，避免不合格处置与返工执行断链；不得实现 GAP-318 FK 重构 |
| 29 | documents/GAP-400 | GAP-400 | 无 | `docs/superpowers/specs/2026-05-02-gap-400-document-version-display-design.md` | `docs/superpowers/plans/2026-05-02-gap-400-document-version-display-implementation.md` | `executing-plans` | 是 | Document 当前版本展示改用 versionNo/Vn，保留 Decimal version 作为历史兼容字段并补齐 legacy versionNo |
| 30 | documents/GAP-401 | GAP-401 | 无 | `docs/superpowers/specs/2026-05-02-gap-401-document-issuance-document-fk-design.md` | `docs/superpowers/plans/2026-05-02-gap-401-document-issuance-document-fk-implementation.md` | `executing-plans` | 是 | DocumentIssuance 必须 FK 到 Document，历史发放记录按 document_code 精确回填，发放时文件名称/编号只作为快照 |
