...
| 18 | quality/GAP-302 | GAP-302 | 无 | `docs/superpowers/specs/2026-05-02-gap-302-environment-record-location-fk-design.md` | `docs/superpowers/plans/2026-05-02-gap-302-environment-record-location-fk-implementation.md` | `executing-plans` | 是 | EnvironmentRecord 新记录必须通过 `location_id` 关联 WorkshopArea 区域主数据，`location` 仅保留快照，避免位置维度继续自由文本漂移 |
