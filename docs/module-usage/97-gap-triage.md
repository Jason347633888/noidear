...
| GAP-305 | P1 | 已验证 | 是 | 是 | 是 | `executing-plans` | docs/superpowers/specs/2026-05-02-gap-305-ccp-deviation-nonconformance-design.md | docs/superpowers/plans/2026-05-02-gap-305-ccp-deviation-nonconformance-implementation.md | spec 和 plan 已写完；执行时只使用 executing-plans，CCP 偏差自动触发 NonConformance |
