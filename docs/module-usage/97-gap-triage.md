...
| GAP-302 | P2 | 已验证 | 是 | 是 | 是 | `executing-plans` | docs/superpowers/specs/2026-05-02-gap-302-environment-record-location-fk-design.md | docs/superpowers/plans/2026-05-02-gap-302-environment-record-location-fk-implementation.md | spec 和 plan 已写完；执行时只使用 executing-plans，EnvironmentRecord 新记录必须通过 `location_id` 关联 WorkshopArea 区域主数据，`location` 仅保留快照 |
