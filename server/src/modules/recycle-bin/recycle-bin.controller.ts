...
export class RecycleBinController {
  ...
  async restore(
    ...
    await this.service.restore(type, id, req.user.userId, req.user.role);
  ...
  async permanentDelete(
    ...
    await this.service.permanentDelete(type, id, req.user.userId, req.user.role);
  ...
  async batchRestore(
    ...
    await this.service.batchRestore(type, dto.ids, req.user.userId, req.user.role);
  ...
  async batchPermanentDelete(
    ...
    await this.service.batchPermanentDelete(type, dto.ids, req.user.userId, req.user.role);
