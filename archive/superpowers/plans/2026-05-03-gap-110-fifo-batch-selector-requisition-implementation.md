...
**历史说明：** 本节原用于同步已退役的 Multica GAP 调度台；当前不再执行。

**Files:**
- 历史 Multica GAP 模块文档已退役；当前不再修改
- 历史 Multica GAP 模块文档已退役；当前不再修改
- 历史 Multica GAP 机器索引已退役；当前不再修改

- [ ] **Step 6.1: 更新 `历史 Multica GAP 分诊表`**
...
- [ ] **Step 6.2: 更新 `历史 Multica GAP PR 排期`**
...
- [ ] **Step 6.3: 更新 `历史 Multica GAP 机器索引`**
...
```bash
# 历史 Multica GAP 调度台已退役；当前不再 stage 这些文件
...
- 历史 Multica GAP 分诊表曾记录：GAP-110 状态更新为"已验证"，plan 路径已填入
- 历史 Multica GAP PR 排期曾记录：GAP-110 新增为第 39 条 PR
- 历史 Multica GAP 机器索引曾记录：GAP-110 已加入 warehouse-inventory 模块，`prOrder=39`
