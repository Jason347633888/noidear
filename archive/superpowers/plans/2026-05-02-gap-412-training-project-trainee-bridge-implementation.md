...
- [ ] **Step 5: Run doc consistency checks if this implementation also touches retired planning docs**

Implementation agents should normally not touch retired planning docs for this plan. If docs are changed during execution, run:
