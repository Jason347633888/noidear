...
本项目规范统一维护在 `./AGENTS.md`。

进入分析、实现、改 schema、改接口、改行为前，先阅读 `AGENTS.md`。
...
This project is indexed by GitNexus as **noidear** (18986 symbols, 32763 relationships, 274 execution flows). Use the GitNexus MCP tools to understand code, assess impact, and navigate safely.
