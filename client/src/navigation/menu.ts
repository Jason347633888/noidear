...
export const menuGroups: MenuGroup[] = [
  ...
  },
  {
    ...
    children: [
      ...
      { path: '/process-records', title: '过程参数', icon: DataAnalysis, moduleKey: 'production_execution' },
      ...
      { path: '/line-change-check-records', title: '换产前检查', icon: RefreshLeft, moduleKey: 'production_execution' },
