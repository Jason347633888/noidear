  ...
  <div class="ii-list-page">
    ...
    >
      <el-form
        ...
        label-width="110px"
      >
        <el-form-item label="入库明细ID" prop="material_inbound_item_id">
          <el-input
            v-model="createForm.material_inbound_item_id"
            placeholder="请输入待检验的入库明细ID"
            clearable
            style="width: 100%"
          />
        </el-form-item>
        <el-form-item label="是否终检">
          <el-switch v-model="createForm.is_final" />
        </el-form-item>
...
const createRules: FormRules = {
  material_inbound_item_id: [{ required: true, message: '请输入入库明细ID', trigger: 'blur' }],
...
function openCreateDialog() {
  createForm.material_inbound_item_id = '';
  createForm.overall_result = '';
  createForm.is_final = false;
...
async function handleCreate() {
  ...
  try {
    await incomingInspectionApi.create({
      material_inbound_item_id: createForm.material_inbound_item_id,
      overall_result: createForm.overall_result,
      is_final: createForm.is_final,
