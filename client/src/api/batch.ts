...
export const materialUsageApi = {
  ...
  // trace bridge. No client create/delete API — usage records are trace facts
  // (the server create and delete routes were removed).
};
